pipeline {
    agent any
     ...
     stages {
       ...
       stage('Run kubectl') {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'k8', contextName: '', credentialsId: KUBERNETES_CREDENTIALS_ID, namespace: NAMESPACE, restrictKubeConfigAccess: false, serverUrl: KUBERNETES_URL) {
